...
% This is disabled because the spm_coreg defaults are optimized for human.
...
% ADVANCED USER ONLY.
%--------------------------------------------------------------------------
% This is disabled because the tissue parameter maps (and probably other 
% defaults) have been made for humans.
