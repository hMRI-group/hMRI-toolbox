...
% ebalteau: copied from spm_dicom_convert where it won't be of any use any
% longer...
%==========================================================================
function val = get_numaris4_val(str,name)
name = deblank(name);
