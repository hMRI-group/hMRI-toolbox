...
% Derivative of MTsat estimate with respect to first weighted signal (S1,
% i.e. SPD). Because of symmetry in the R1 and A calculations, the
% derivative with respect to the second weighted signal can be computed
% by permuting labels.
%
...
% Derivative of MTsat estimate with respect to MT weighted signal (SMT).
%
% Can be derived using:
%   syms S1 alpha1 S2 alpha2 SMT alphaMT
%   syms TR1 TR2 TRMT positive
