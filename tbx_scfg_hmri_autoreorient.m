...
ref.help    = {['Select the image that is best suited for rigid-body ' ...
    'coregistration to MNI space, i.e. the GM/WM contrast in that image ' ...
...
template.help    = {['Auto-reorient needs to know which modality of image ' ...
    ...
    'other source of your choice. NOTE: The template must already be in the MNI orientation ' ...
    'to make the reorientation effective! By defaults, SPM12/canonical/avg152T1.nii is used.']};
...
other.help    = {['Select all the other images that need to remain in alignment ' ...
    'with the image that is reoriented. Typically, all the images acquired ' ...
    'during a single MRI session should be reoriented together.']};
other.filter  = 'image';
other.ufilter = '.*';
other.num     = [0 Inf];
