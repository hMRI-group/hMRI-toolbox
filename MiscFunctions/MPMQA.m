...
% Notes: a. Specific 'MTProtQA.m' version of MTProt.m with settings
...
function MPMQA(ImagedObject,ImageLoading,QAMode)
...
MTProtQA(P_mtw, P_pdw, P_t1w, TE_mtw, TE_pdw, TE_t1w, TR_mtw, TR_pdw, TR_t1w, fa_mtw, fa_pdw, fa_t1w, P_trans, P_receiv);
end
function p = hinfo(P)
N = nifti(P);
for ii = 1:numel(N),
