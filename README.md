...
that can be used for accurate delineation of subcortical brain structures 
...
The qMRI maps generated by the toolbox are key input parameters 
...
please use this pre-print paper and cite it when publishing results compiled with the hMRI-toolbox. 
