...
customised.help    = {['Select the ''hmri_defaults_local*.m'' file containing ' ...
...
hmri_config.help    = {['Customised defaults parameters can be set here by selecting ' ...
    'customised hmri_defaults_local_*.m file. Type "help hmri_defaults_local" for ' ...
    'more details.']};
