...
std.help    = {['Specify the standard deviation cut off for denoising'], ['This parameter' ...
    'is teh factor of the local noise level to remove PCA components. Higher values remove more components.' ...
    'The optimal cutoff can be increased when including more images. ' ...
    'We recommend the following cut-ff sizes for various image numbers:' ...
