function tbx_scfg_hmri_wcomb = hMRI_create_wcomb
...
tbx_scfg_hmri_wcomb         = cfg_exbranch;
tbx_scfg_hmri_wcomb.tag     = 'tbx_scfg_hmri_wcomb';
tbx_scfg_hmri_wcomb.name    = 'Combine two successsive hMRI datasets';
tbx_scfg_hmri_wcomb.val     = {in_vols1 in_vols2 in_weights1 in_weights2 in_ref in_msk};
tbx_scfg_hmri_wcomb.help    = {
...
tbx_scfg_hmri_wcomb.prog = @local_hmri_wcomb;
tbx_scfg_hmri_wcomb.vout = @out_hmri_wcomb;
%% dependencies
function out = local_hmri_wcomb(job)
hMRI_wcomb(char(job.in_vols1), char(job.in_vols2), char(job.in_weights1), char(job.in_weights2), char(job.in_ref), char(job.in_msk));
