...
b1_input_3DEPI.help      = {'Input B0/B1 data for 3D EPI protocol'
    ...
    ['The images are expected to be in the order SE_beta1, STE_beta1, SE_beta2, STE_beta2, ' ...
    'SE_betaN, STE_betaN, where beta1 to betaN are in the same order as in "b1acq.beta". ' ...
    'This matches the ordering of the DICOMs from typical implementations of the sequence.']
