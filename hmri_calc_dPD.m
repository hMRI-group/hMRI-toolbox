...
% Calculate propagation of uncertainty for PD (or unnormalised A) map
...
% Derivative of dual flip-angle PD (A) estimate with respect to first
% weighted signal (S1). Because of symmetry in the PD calculation, the
