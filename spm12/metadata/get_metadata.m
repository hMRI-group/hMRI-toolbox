function hdr = get_metadata(varargin)
%==========================================================================
% PURPOSE
...
for cfile = 1:size(filelist,1)
    ...
    switch lower(ext)
        case '.nii'
            ...
            if isHdrExtended(1)
                % fprintf('\nINFO: Nifti header extension available in file \n%s \n',filelist(cfile,:));
        ...
        case '.json'
            ...
            try
                ...
                hdr{cfile}.filename = filelist(cfile,:);
            catch 
